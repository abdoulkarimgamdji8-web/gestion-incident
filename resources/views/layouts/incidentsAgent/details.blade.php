                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-4">
                                    ...
                                    <p>{{ optional($incident->domaine)->nom_domaine ?? 'N/A' }}</p>
                                </div>
                                <div class="col-md-4">
                                    <strong>Station :</strong>
                                    <p>{{ optional($incident->station)->nom ?? 'N/A' }}</p>
                                </div>
                                <div class="col-md-4">
                                    <strong>Équipement :</strong>
                                    <p>{{ optional($incident->equipement)->nom ?? 'N/A' }}</p>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <p>{{ optional($incident->technicien)->prenom ?? 'Non assigné' }}
                                        {{ optional($incident->technicien)->nom ?? '' }}</p>
                                </div>
                            </div>
                            ...
                            <div class="row mb-4">
                                <div class="col-md-4">
                                    ...
                                    <p>{{ $incident->date_signalement?->format('d/m/Y H:i') ?? 'N/A' }}</p>
                                </div>
                            </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="d-flex align-items-center p-2 border rounded gap-2">
                                                        ...
                                                        <a href="{{ asset('storage/' . $pj->chemin_fichier) }}"
                                                            target="_blank" class="btn btn-sm btn-gradient-primary">
                                                ...
                                                @if (in_array($role, ['Agent Station', 'Sous-gérant de station']))
                                                    <form method="POST"
                                                        ...
                                                        <button type="submit" class="btn btn-gradient-warning btn-sm">
                                                            <i class="mdi mdi-send"></i> Signaler un problème
                                                        </button>
                                                    </form>
                                                @endif
                                            </div>
                            ...
                            <div class="mt-4 d-flex gap-2">
                                ...
                                @elseif(in_array($role, ['Directeur Technique', 'Responsable DT', 'Responsable Maintenance', 'Directeur Maintenance']))
                                ...
                                {{-- Clôturer : sous-gérant si statut résolu --}}
                                @if (in_array($role, ['Agent Station', 'Sous-gérant de station']) && $incident->statut === 'resolu')
                                    <form action="{{ route('incidents.cloturer', $incident->id) }}" method="POST"
