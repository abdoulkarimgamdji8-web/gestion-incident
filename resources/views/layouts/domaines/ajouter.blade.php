  ...
  <div class="content-wrapper d-flex align-items-center justify-content-center auth" style="min-height:100vh;">
    <div class="col-lg-6 col-md-8 col-sm-12" style="max-width:600px; width:100%;">
      ...
      <div class="auth-form-light text-left p-4 p-lg-5">
        <h3 class="text-center mb-2">Ajouter un domaine</h3>
        <p class="text-center text-muted mb-4">Créez un nouveau domaine pour les utilisateurs.</p>
        ...
        <form class="pt-3" method="POST" action="{{ route('domaines.store') }}">
          @csrf

          <div class="form-group mb-3">
            <label for="nom_domaine" class="form-label">Nom du domaine</label>
            <input type="text" name="nom_domaine" class="form-control form-control-lg" id="nom_domaine" placeholder="Ex : Réseau, Sécurité" value="{{ old('nom_domaine') }}" required>
          </div>
