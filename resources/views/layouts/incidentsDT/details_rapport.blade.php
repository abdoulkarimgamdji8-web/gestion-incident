        ...
        <div class="content-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-md-8 mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST"
                                        ...
                                        <input type="hidden" name="contenu"
                                            value="L'intervention sur votre incident est terminée. Merci de vérifier sur le terrain et de clôturer si tout est en ordre.">
                    ...
                    {{-- Réassigner : DT si statut résolu ET mémo du sous-gérant existe --}}
                    @php
                        $memoSousGerantExiste =
                            $incident->commentaires
                                ->filter(function ($c) {
                                    return in_array($c->user->role->nom_role, [
                                        'Agent Station',
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <h4 class="card-title text-danger">
                                    ...
                                    Problème non résolu — Réassigner
                                </h4>
                                <p class="text-muted small">
                                    Le sous-gérant a signalé que le problème n'est pas résolu.
                                ...
                                @else
                                    <form method="POST" action="{{ route('incidents.reassigner', $incident->id) }}">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select name="technicien_assigne_id" class="form-select form-control-lg"
                                                required>
                                                ...
                                                @foreach ($intervenants as $intervenant)
                                                    <option value="{{ $intervenant->id }}">
                                                        ...
                                                        — {{ optional($intervenant->domaine)->nom_domaine}}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
